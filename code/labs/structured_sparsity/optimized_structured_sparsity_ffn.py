"""Optimized structured sparsity FFN lab (cuSPARSELt + CUDA graphs)."""
...
class OptimizedStructuredSparsityFFNLab(VerificationPayloadMixin, BaseBenchmark):
    """Structured-sparse FFN optimized with cuSPARSELt and CUDA graph replay."""
...
def get_benchmark() -> BaseBenchmark:
    return OptimizedStructuredSparsityFFNLab()
