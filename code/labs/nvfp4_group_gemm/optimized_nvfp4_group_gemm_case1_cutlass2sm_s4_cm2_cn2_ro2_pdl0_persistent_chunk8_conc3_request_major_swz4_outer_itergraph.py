"""CUTLASS NVFP4 grouped GEMM (competition case 1) - s4 chunk8 conc3 cn2 request_major swz4 outer iter-graph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            "nvfp4_group_gemm_"
            f"{case.name}_optimized_cutlass_cached_2sm_s4_cm2_cn2_ro2_pdl0_"
