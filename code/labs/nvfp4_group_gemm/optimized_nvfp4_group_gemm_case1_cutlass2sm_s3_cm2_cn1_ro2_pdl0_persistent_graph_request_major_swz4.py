"""CUTLASS NVFP4 grouped GEMM (competition case 1) - 2SM StageCount=3, persistent graph + request-major task order + swizzle 4."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_graph_request_major_swz4"
        ),
    )
