"""CUTLASS NVFP4 grouped GEMM (competition case 2) - tuned 2SM N128 + fused-request plan."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_2sm_n128_persistent,
        inputs_per_iteration=15,
        capture_iter_graph=False,
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_n128_cm2_cn1_ro2_pdl1_persistent",
    )
