"""CUTLASS NVFP4 grouped GEMM (competition case 0) - outer iter-graph + StageCount=4 persistent request-major (PDL off, swz0)."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_request_major_swz0_outer_itergraph"
        ),
    )
