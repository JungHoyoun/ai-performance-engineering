"""CUTLASS NVFP4 grouped GEMM (competition case 1) - 2SM n128_s1 persistent request-major (PDL off, swz0)."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_2sm_n128_s1_persistent_graph,
        inputs_per_iteration=15,
        capture_iter_graph=False,
        name=(
            f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_n128_s1_"
