"""CUTLASS NVFP4 grouped GEMM (competition case 1) - 2SM n128_s4 cn2 persistent request-major (PDL off, swz0, iter-graph)."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_2sm_n128_s4_persistent_graph,
        inputs_per_iteration=15,
        capture_iter_graph=True,
        name=(
            f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_n128_s4_"
            "cm2_cn2_ro2_pdl0_persistent_graph_request_major_swz0_itergraph"
        ),
    )
