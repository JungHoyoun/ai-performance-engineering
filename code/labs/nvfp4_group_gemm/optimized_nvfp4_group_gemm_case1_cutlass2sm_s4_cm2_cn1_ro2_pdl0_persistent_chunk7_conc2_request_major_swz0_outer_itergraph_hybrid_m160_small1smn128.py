"""CUTLASS NVFP4 grouped GEMM (case 1) - persistent hybrid split at M<=160."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_HYBRID_M_THRESHOLD"] = "160"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "outer_itergraph_hybrid_m160_small1smn128"
        ),
    )
