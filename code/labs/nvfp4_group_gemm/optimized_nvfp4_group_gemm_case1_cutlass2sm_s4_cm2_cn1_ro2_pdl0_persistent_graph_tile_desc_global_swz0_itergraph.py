"""CUTLASS NVFP4 grouped GEMM (competition case 1) - S4 + tile-desc global task order + iter-graph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_graph_tile_desc_global_swz0_itergraph"
        ),
    )
