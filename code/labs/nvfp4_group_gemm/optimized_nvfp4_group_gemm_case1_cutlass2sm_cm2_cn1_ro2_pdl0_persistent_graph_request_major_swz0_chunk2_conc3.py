"""CUTLASS NVFP4 grouped GEMM (competition case 1) - persistent graph request-major swz0, chunk2 + conc3."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_REQUEST_CHUNK"] = "2"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_graph_request_major_swz0_chunk2_conc3"
        ),
    )
