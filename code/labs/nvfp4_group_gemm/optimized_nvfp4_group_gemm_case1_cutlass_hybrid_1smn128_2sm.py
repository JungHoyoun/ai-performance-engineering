...
Small-M groups (M <= threshold) run on 1SM N128 tiles.
Large-M groups run on 2SM tiles.
"""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_hybrid_1smn128_2sm",
    )
