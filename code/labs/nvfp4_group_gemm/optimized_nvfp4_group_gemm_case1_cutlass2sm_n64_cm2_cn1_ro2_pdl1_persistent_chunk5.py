"""CUTLASS NVFP4 grouped GEMM (competition case 1) - 2SM N64 persistent chunk=5.
...
- raster_order=2
- use_pdl=1
- persistent_request_chunk=5 (three launches per iteration for 15 requests)
"""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_n64_cm2_cn1_ro2_pdl1_persistent_chunk5",
    )
