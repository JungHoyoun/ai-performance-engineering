"""CUTLASS NVFP4 grouped GEMM (competition case 1) - persistent graph + tiles-desc group order."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_cm2_cn1_ro2_pdl0_persistent_graph_tiles_desc",
    )
