"""CUTLASS NVFP4 grouped GEMM (competition case 3) - 1SM MMA (N=64 tile).
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_1sm_n64,
        inputs_per_iteration=15,
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_1sm_n64",
    )
