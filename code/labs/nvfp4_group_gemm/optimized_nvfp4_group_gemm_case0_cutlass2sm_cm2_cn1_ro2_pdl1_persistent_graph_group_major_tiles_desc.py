"""CUTLASS NVFP4 grouped GEMM (competition case 0) - persistent graph + group-major task order + tiles-desc group ordering."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl1_persistent_graph_group_major_tiles_desc"
        ),
    )
