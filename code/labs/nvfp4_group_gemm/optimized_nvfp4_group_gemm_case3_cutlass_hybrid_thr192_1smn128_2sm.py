"""CUTLASS NVFP4 grouped GEMM (competition case 3) - hybrid 1SM/2SM split.

M <= 192 groups run on 1SM N128 tiles; larger groups run on 2SM.
"""
...
os.environ.setdefault("AISP_NVFP4_GROUP_GEMM_HYBRID_M_THRESHOLD", "192")
...
os.environ.setdefault("AISP_NVFP4_GROUP_GEMM_HYBRID_LARGE_RASTER_ORDER", "0")
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_hybrid_1sm_n128_2sm,
        inputs_per_iteration=15,
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_hybrid_thr192_1smn128_2sm",
    )
