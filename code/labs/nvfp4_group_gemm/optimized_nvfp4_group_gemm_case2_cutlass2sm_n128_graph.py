"""CUTLASS NVFP4 grouped GEMM (competition case 2) - 2SM N128 with CUDA Graph replay."""
...
# Start from the best-known tuned launch for this case and tile family.
os.environ.setdefault("AISP_NVFP4_GROUP_GEMM_CLUSTER_M", "2")
os.environ.setdefault("AISP_NVFP4_GROUP_GEMM_CLUSTER_N", "1")
os.environ.setdefault("AISP_NVFP4_GROUP_GEMM_RASTER_ORDER", "2")
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_2sm_n128_graph,
        inputs_per_iteration=15,
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_n128_graph",
    )
