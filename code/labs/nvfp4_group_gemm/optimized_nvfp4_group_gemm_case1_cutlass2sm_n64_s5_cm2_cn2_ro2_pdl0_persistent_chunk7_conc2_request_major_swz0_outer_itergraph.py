"""CUTLASS NVFP4 grouped GEMM (competition case 1) - n64_s5 chunk7 conc2 cn2 request_major swz0 outer iter-graph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            "nvfp4_group_gemm_"
            f"{case.name}_optimized_cutlass_cached_2sm_n64_s5_cm2_cn2_ro2_pdl0_"
            "persistent_chunk7_conc2_request_major_swz0_outer_itergraph"
        ),
    )
