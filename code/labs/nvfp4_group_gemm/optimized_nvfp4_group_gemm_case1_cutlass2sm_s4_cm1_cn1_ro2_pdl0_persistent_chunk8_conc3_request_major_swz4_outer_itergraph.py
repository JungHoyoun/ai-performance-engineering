"""CUTLASS NVFP4 grouped GEMM (competition case 1) - s4 cm1 chunk8 conc3 swz4 outer iter-graph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm1_cn1_ro2_pdl0_persistent_chunk8_conc3_request_major_swz4_outer_itergraph"
        ),
    )
