"""CUTLASS NVFP4 grouped GEMM (competition case 1) - persistent graph + request-major task order + tiles-zigzag group ordering."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_GROUP_ORDER"] = "tiles_zigzag"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_graph_request_major_tiles_zigzag"
        ),
    )
