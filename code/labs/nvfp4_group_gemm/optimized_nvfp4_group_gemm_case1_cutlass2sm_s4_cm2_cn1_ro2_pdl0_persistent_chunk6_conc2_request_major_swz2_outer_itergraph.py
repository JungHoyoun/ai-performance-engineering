"""CUTLASS NVFP4 grouped GEMM (competition case 1) - s4 chunk6 conc2 swz2 outer iter-graph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_chunk6_conc2_request_major_swz2_outer_itergraph"
        ),
    )
