"""CUTLASS NVFP4 grouped GEMM (competition case 0) - 2SM StageCount=4 + itergraph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_2sm_s4,
        inputs_per_iteration=15,
        capture_iter_graph=True,
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_s4_cm2_cn1_ro2_pdl1_itergraph",
    )
