"""CUTLASS NVFP4 grouped GEMM (competition case 2) - tuned 2SM N128 + CUDA Graph replay.

Hard-sets a candidate schedule for fixed-clock tuning:
- cluster_m=2
- cluster_n=1
- raster_order=2
- use_pdl=1
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_n128_cm2_cn1_ro2_pdl1_graph",
    )
