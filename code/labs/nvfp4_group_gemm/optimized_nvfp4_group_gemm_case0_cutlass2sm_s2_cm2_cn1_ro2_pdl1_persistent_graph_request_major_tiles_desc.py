"""CUTLASS NVFP4 grouped GEMM (competition case 0) - 2SM StageCount=2 persistent graph + request-major tiles-desc ordering."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_2sm_s2_persistent_graph,
        inputs_per_iteration=15,
        capture_iter_graph=False,
        name=(
            f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_s2_"
