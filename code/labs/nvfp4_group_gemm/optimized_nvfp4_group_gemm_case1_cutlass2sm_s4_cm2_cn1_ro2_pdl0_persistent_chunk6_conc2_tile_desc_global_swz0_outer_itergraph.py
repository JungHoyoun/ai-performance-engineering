"""CUTLASS NVFP4 grouped GEMM (competition case 1) - s4 chunk6 conc2 tiles-desc outer iter-graph."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_REQUEST_CHUNK"] = "6"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_chunk6_conc2_tiles_desc_swz0_outer_itergraph"
        ),
    )
