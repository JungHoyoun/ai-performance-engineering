"""CUTLASS NVFP4 grouped GEMM (competition case 1) tile-zigzag task ordering variant."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_TASK_ORDER"] = "tile_zigzag_global"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_chunk8_conc5_tile_zigzag_global_m_desc_"
