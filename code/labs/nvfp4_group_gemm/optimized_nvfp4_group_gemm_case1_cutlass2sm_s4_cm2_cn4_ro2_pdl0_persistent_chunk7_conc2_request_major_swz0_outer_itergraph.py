"""CUTLASS NVFP4 grouped GEMM (competition case 1) - s4 chunk7 conc2 cn4 request_major swz0 outer iter-graph."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_CLUSTER_N"] = "4"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_s4_cm2_cn4_ro2_pdl0_persistent_chunk7_conc2_request_major_swz0_outer_itergraph"
        ),
    )
