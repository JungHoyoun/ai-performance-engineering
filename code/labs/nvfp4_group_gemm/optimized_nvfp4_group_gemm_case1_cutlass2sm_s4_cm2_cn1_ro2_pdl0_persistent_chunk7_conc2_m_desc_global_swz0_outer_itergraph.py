"""CUTLASS NVFP4 grouped GEMM (competition case 1) - s4 chunk7 conc2 m-desc-global outer iter-graph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_chunk7_conc2_m_desc_global_swz0_outer_itergraph"
        ),
    )
