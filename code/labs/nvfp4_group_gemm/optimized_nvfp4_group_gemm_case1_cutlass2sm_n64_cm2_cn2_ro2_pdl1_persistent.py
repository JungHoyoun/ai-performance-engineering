"""CUTLASS NVFP4 grouped GEMM (competition case 1) - tuned 2SM N64 + fused-request plan."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_n64_cm2_cn2_ro2_pdl1_persistent",
    )
