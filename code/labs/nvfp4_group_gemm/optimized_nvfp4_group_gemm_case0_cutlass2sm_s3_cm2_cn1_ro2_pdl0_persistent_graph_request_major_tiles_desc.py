"""CUTLASS NVFP4 grouped GEMM (competition case 0) - stage3 persistent graph request-major (PDL off)."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_STAGE_COUNT"] = "3"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "s3_cm2_cn1_ro2_pdl0_persistent_graph_request_major_tiles_desc"
        ),
    )
