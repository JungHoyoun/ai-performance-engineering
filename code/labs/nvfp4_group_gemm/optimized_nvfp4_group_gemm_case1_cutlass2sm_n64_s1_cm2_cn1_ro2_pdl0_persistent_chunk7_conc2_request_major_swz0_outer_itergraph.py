"""CUTLASS NVFP4 grouped GEMM (competition case 1) - n64_s1 chunk7 conc2 cn1 request_major swz0 outer iter-graph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_2sm_n64_s1_persistent,
        inputs_per_iteration=15,
        capture_iter_graph=True,
        name=(
            f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_n64_s1_cm2_cn1_ro2_pdl0_persistent_chunk7_conc2_request_major_swz0_outer_itergraph"
        ),
    )
