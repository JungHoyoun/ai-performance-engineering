"""CUTLASS NVFP4 grouped GEMM (competition case 1) - hybrid 1SM/2SM with CUDA Graph replay.

Small-M groups run on 1SM N64 tiles. Larger groups run on 2SM tiles (raster_order=2).
"""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_hybrid_1sm_n64_2sm_graph,
        inputs_per_iteration=15,
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_hybrid_1smn64_2sm_lro2_graph",
    )
