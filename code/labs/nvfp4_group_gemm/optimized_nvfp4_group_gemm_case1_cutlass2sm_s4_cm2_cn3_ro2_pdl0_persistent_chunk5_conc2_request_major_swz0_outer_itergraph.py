"""CUTLASS NVFP4 grouped GEMM (competition case 1) - s4 chunk5 conc2 cn3 outer iter-graph."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_CLUSTER_N"] = "3"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn3_ro2_pdl0_persistent_chunk5_conc2_request_major_swz0_outer_itergraph"
        ),
    )
