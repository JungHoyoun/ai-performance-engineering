"""CUTLASS NVFP4 grouped GEMM (competition case 1) with balanced persistent stream scheduling (conc6)."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_CONCURRENT_STREAMS"] = "6"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_chunk8_conc6_request_major_m_desc_"
            "swz4_outer_itergraph_balstream_frontload"
        ),
    )
