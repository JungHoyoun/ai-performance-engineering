"""CUTLASS NVFP4 grouped GEMM (competition case 2) - 2SM N128 StageCount=3, persistent graph + tile-desc global task order."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_2sm_n128_s3_persistent_graph,
        inputs_per_iteration=15,
        capture_iter_graph=False,
        name=(
            f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_n128_s3_"
            "cm2_cn1_ro2_pdl1_persistent_graph_tile_desc_global_swz0"
        ),
    )
