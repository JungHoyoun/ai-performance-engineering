"""CUTLASS NVFP4 grouped GEMM (competition case 1) - s4 chunk4 conc2 outer iter-graph."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_REQUEST_CHUNK"] = "4"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_chunk4_conc2_request_major_swz0_outer_itergraph"
        ),
    )
