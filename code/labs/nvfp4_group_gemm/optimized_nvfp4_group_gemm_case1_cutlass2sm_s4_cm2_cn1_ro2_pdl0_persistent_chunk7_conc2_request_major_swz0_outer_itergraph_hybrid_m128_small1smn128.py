"""CUTLASS NVFP4 grouped GEMM (case 1) - persistent hybrid split at M<=128."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_HYBRID_SMALL_VARIANT"] = "1sm_n128"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "outer_itergraph_hybrid_m128_small1smn128"
        ),
    )
