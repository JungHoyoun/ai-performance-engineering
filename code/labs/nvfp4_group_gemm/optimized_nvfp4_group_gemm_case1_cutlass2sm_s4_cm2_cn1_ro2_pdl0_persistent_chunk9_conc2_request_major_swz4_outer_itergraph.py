"""CUTLASS NVFP4 grouped GEMM (competition case 1) - s4 chunk9 conc2 swz4 outer iter-graph."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_REQUEST_CHUNK"] = "9"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_chunk9_conc2_request_major_swz4_outer_itergraph"
        ),
    )
