"""CUTLASS NVFP4 grouped GEMM (competition case 1) - 2SM persistent + M-zigzag fused ordering.
...
- raster_order=2
- use_pdl=1
- persistent_request_chunk=0 (single fused grouped launch)
- persistent_group_order=m_zigzag (alternate heavy/light groups)
"""
...
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_GROUP_ORDER"] = "m_zigzag"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_cm2_cn1_ro2_pdl1_persistent_mzigzag",
    )
