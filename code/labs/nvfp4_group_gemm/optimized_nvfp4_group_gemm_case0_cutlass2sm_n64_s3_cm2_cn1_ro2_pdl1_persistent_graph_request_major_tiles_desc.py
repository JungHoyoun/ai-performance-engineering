"""CUTLASS NVFP4 grouped GEMM (competition case 0) - 2SM N64 StageCount=3 persistent graph + request-major tiles-desc ordering."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_GROUP_ORDER"] = "tiles_desc"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_2sm_n64_s3_persistent_graph,
        inputs_per_iteration=15,
        capture_iter_graph=False,
        name=(
            f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_n64_s3_"
            "cm2_cn1_ro2_pdl1_persistent_graph_request_major_tiles_desc"
        ),
    )
