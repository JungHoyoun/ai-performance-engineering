"""CUTLASS NVFP4 grouped GEMM (competition case 2) - hybrid 1SM/2SM split.

M <= 255 groups run on 1SM N128 tiles; larger groups run on 2SM.
"""
...
os.environ.setdefault("AISP_NVFP4_GROUP_GEMM_HYBRID_M_THRESHOLD", "255")
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_hybrid_thr255_1smn128_2sm",
    )
