"""CUTLASS NVFP4 grouped GEMM (case 1) - fused chunk15 m-desc global ordering."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_2sm_mxf4_persistent,
        inputs_per_iteration=15,
        capture_iter_graph=True,
        name=(
            f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_mxf4_"
            "cm2_cn1_ro2_pdl0_persistent_chunk15_conc1_"
            "mdescglobal_mdesc_swz0_outer_itergraph_balstream"
        ),
    )
