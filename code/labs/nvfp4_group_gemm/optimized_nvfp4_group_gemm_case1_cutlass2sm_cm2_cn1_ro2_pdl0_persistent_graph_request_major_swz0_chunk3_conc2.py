"""CUTLASS NVFP4 grouped GEMM (competition case 1) - persistent graph request-major swz0, chunk3 + conc2."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_graph_request_major_swz0_chunk3_conc2"
        ),
    )
