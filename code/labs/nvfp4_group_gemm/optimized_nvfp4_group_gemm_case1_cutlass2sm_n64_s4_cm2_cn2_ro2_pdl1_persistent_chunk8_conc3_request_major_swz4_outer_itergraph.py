"""CUTLASS NVFP4 grouped GEMM (competition case 1) - n64_s4 pdl1 chunk8 conc3 swz4 outer iter-graph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn2_ro2_pdl1_persistent_chunk8_conc3_request_major_swz4_outer_itergraph"
        ),
    )
