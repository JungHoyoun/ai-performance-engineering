"""CUTLASS NVFP4 grouped GEMM (competition case 1) - s4 chunk5 conc4 outer iter-graph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_chunk5_conc4_request_major_swz0_outer_itergraph"
        ),
    )
