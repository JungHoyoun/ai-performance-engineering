"""CUTLASS NVFP4 grouped GEMM (competition case 1) - S4 CM1 chunked outer iter-graph (swz4)."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm1_cn1_ro2_pdl0_persistent_chunk5_conc2_request_major_swz4_outer_itergraph"
        ),
    )
