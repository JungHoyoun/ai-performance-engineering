"""CUTLASS NVFP4 grouped GEMM (competition case 1) - 2SM n64_s4 cn2 persistent-graph request_major m_desc swz4 pdl1 iter-graph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_2sm_n64_s4_persistent_graph,
        inputs_per_iteration=15,
        capture_iter_graph=True,
        name=(
            f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_n64_s4_"
            "cm2_cn2_ro2_pdl1_persistent_graph_request_major_m_desc_swz4_itergraph"
        ),
    )
