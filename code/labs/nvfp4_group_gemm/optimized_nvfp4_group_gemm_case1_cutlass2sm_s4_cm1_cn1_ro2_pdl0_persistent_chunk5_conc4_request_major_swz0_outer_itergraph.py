"""CUTLASS NVFP4 grouped GEMM (competition case 1) - S4 CM1 chunked outer iter-graph (conc4)."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm1_cn1_ro2_pdl0_persistent_chunk5_conc4_request_major_swz0_outer_itergraph"
        ),
    )
