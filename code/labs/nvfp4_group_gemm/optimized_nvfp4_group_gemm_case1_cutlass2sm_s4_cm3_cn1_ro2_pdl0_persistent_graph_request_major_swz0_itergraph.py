"""CUTLASS NVFP4 grouped GEMM (competition case 1) - 2SM StageCount=4 + cm3 + iter-graph replay."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_CLUSTER_M"] = "3"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_2sm_s4_persistent_graph,
        inputs_per_iteration=15,
        capture_iter_graph=True,
        name=(
            f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_s4_"
            "cm3_cn1_ro2_pdl0_persistent_graph_request_major_swz0_itergraph"
        ),
    )
