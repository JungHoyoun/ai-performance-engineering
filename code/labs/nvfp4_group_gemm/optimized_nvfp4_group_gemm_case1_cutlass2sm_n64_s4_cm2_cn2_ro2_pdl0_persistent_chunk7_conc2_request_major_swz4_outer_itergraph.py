"""CUTLASS NVFP4 grouped GEMM (competition case 1) - n64_s4 chunk7 conc2 cn2 request_major swz4 outer iter-graph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_n64_s4_cm2_cn2_ro2_pdl0_persistent_chunk7_conc2_request_major_swz4_outer_itergraph"
        ),
    )
