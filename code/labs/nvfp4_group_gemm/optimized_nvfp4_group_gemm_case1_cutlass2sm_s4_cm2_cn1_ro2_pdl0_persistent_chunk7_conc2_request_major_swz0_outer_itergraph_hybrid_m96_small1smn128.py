"""CUTLASS NVFP4 grouped GEMM (case 1) - persistent hybrid split at M<=96."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_HYBRID_M_THRESHOLD"] = "96"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "outer_itergraph_hybrid_m96_small1smn128"
        ),
    )
