"""CUTLASS NVFP4 grouped GEMM (competition case 1) - s5 chunk7 conc2 request-major + stream balance."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_2sm_s5_persistent,
        inputs_per_iteration=15,
        capture_iter_graph=True,
        name=(
            f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_s5_"
            "cm2_cn1_ro2_pdl0_persistent_chunk7_conc2_request_major_swz0_outer_itergraph_balstream"
        ),
    )
