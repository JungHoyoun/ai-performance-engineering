...
Same as the base hybrid variant but forces raster_order=2 for the large-M 2SM plan.
"""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_hybrid_1smn128_2sm_lro2",
    )
