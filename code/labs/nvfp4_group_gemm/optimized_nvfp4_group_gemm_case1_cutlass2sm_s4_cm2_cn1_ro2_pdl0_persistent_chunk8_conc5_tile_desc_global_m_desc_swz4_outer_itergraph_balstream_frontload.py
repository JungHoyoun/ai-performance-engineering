"""CUTLASS NVFP4 grouped GEMM (competition case 1) tile-desc task ordering + balanced stream frontload."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_chunk8_conc5_tile_desc_global_m_desc_"
