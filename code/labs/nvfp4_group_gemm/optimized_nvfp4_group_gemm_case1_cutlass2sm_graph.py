"""CUTLASS NVFP4 grouped GEMM (competition case 1) - 2SM with CUDA Graph replay."""
...
# Match best-known launch settings for this case; allow override.
os.environ.setdefault("AISP_NVFP4_GROUP_GEMM_USE_PDL", "0")
