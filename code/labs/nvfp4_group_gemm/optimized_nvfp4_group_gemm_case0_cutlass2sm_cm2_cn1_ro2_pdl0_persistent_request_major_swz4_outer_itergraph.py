"""CUTLASS NVFP4 grouped GEMM (competition case 0) - outer iter-graph + persistent request-major (PDL off, swz4)."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_request_major_swz4_outer_itergraph"
        ),
    )
