"""CUTLASS NVFP4 grouped GEMM (competition case 1) cluster_m sweep variant."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_CLUSTER_M"] = "4"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm4_cn1_ro2_pdl0_persistent_chunk8_conc5_tile_desc_global_m_desc_"
