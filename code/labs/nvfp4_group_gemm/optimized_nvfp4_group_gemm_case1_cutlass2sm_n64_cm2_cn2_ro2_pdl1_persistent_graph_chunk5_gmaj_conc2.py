"""CUTLASS NVFP4 grouped GEMM (competition case 1) - persistent graph chunking, group-major order, 2 streams."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn2_ro2_pdl1_persistent_graph_chunk5_gmaj_conc2"
        ),
    )
