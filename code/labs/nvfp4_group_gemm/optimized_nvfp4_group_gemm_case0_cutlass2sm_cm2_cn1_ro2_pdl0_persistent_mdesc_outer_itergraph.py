"""CUTLASS NVFP4 grouped GEMM (competition case 0) - outer iter-graph + persistent m-desc ordering (PDL off, swz0)."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_mdesc_outer_itergraph"
        ),
    )
