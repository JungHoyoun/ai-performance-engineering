"""CUTLASS NVFP4 grouped GEMM (competition case 0) - persistent graph + request-major task order + cluster_n 2."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn2_ro2_pdl1_persistent_graph_request_major_swz0"
        ),
    )
