"""CUTLASS NVFP4 grouped GEMM (competition case 1) with balanced persistent stream scheduling (conc4)."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_chunk8_conc4_request_major_m_desc_"
