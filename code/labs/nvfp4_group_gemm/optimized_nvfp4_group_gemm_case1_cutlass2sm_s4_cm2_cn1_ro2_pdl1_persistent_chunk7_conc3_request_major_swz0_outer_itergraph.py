"""CUTLASS NVFP4 grouped GEMM (competition case 1) - s4 chunk7 conc3 pdl1 swz0 outer iter-graph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl1_persistent_chunk7_conc3_request_major_swz0_outer_itergraph"
        ),
    )
