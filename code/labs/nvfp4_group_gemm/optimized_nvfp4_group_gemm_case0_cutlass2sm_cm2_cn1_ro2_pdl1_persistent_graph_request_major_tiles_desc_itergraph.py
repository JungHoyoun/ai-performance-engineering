"""CUTLASS NVFP4 grouped GEMM (competition case 0) - best persistent schedule + iter-graph replay."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl1_persistent_graph_request_major_tiles_desc_itergraph"
        ),
    )
