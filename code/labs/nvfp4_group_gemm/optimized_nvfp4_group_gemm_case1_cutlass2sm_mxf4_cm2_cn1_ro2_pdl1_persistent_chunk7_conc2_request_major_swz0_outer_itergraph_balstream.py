"""CUTLASS NVFP4 grouped GEMM (case 1) - mxf4 chunk7 conc2 request-major swz0 + stream balance."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl1_persistent_chunk7_conc2_request_major_swz0_outer_itergraph_balstream"
        ),
    )
