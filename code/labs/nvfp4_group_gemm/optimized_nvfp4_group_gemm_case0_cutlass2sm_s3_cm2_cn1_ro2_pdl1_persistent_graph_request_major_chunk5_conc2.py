"""CUTLASS NVFP4 grouped GEMM (competition case 0) - 2SM StageCount=3, persistent graph + request-major task order + chunk 5 + concurrency 2."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl1_persistent_graph_request_major_chunk5_conc2"
        ),
    )
