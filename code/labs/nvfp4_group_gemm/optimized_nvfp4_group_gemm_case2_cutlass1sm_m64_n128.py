"""CUTLASS NVFP4 grouped GEMM (competition case 2) - 1SM MMA, N=128 tile (PDL + cluster_n=2).
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_1sm_n128_pdl_cluster_n2",
    )
