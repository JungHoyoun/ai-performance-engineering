"""CUTLASS NVFP4 grouped GEMM (competition case 1) - persistent graph swizzle4, chunk5, group-major order, 2 streams."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_graph_swz4_chunk5_gmaj_conc2"
        ),
    )
