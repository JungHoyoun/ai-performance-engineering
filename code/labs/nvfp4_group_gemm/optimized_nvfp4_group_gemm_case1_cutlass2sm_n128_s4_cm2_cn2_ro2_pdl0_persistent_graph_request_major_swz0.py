"""CUTLASS NVFP4 grouped GEMM (competition case 1) - 2SM n128_s4 cn2 persistent request-major (PDL off, swz0)."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn2_ro2_pdl0_persistent_graph_request_major_swz0"
        ),
    )
