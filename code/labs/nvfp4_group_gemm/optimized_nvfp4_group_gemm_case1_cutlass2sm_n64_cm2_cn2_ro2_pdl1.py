"""CUTLASS NVFP4 grouped GEMM (competition case 1) - tuned 2SM N64 launch.
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_2sm_n64,
        inputs_per_iteration=15,
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_n64_cm2_cn2_ro2_pdl1",
    )
