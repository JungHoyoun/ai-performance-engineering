"""CUTLASS NVFP4 grouped GEMM (competition case 1) - hybrid 1SM/2SM split.

M <= 160 groups run on 1SM N64 tiles; larger groups run on 2SM with raster_order=2.
"""
...
os.environ.setdefault("AISP_NVFP4_GROUP_GEMM_HYBRID_M_THRESHOLD", "160")
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_hybrid_1sm_n64_2sm,
        inputs_per_iteration=15,
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_hybrid_thr160_1smn64_2sm_lro2",
    )
