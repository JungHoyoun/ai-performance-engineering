"""CUTLASS NVFP4 grouped GEMM (case 1) - persistent hybrid split at M<=128 using 1SM N64 for small groups."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_HYBRID_ENABLE"] = "1"
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_HYBRID_M_THRESHOLD"] = "128"
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_HYBRID_SMALL_VARIANT"] = "1sm_n64"
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_HYBRID_LARGE_VARIANT"] = "2sm_s4"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_chunk7_conc2_request_major_swz0_"
            "outer_itergraph_hybrid_m128_small1smn64"
        ),
    )
