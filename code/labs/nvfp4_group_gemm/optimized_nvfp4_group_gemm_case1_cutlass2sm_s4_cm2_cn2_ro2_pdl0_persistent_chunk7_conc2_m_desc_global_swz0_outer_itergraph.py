"""CUTLASS NVFP4 grouped GEMM (competition case 1) - s4 chunk7 conc2 cn2 m_desc_global swz0 outer iter-graph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_s4_cm2_cn2_ro2_pdl0_persistent_chunk7_conc2_m_desc_global_swz0_outer_itergraph"
        ),
    )
