"""CUTLASS NVFP4 grouped GEMM (competition case 2) - tuned 2SM N128 + iteration graph replay."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_n128_cm2_cn1_ro2_pdl1_itergraph",
    )
