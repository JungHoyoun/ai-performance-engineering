"""CUTLASS NVFP4 grouped GEMM (case 1) - mxf4 chunk8 conc3 tile-desc global swz4 + stream balance."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl1_persistent_chunk8_conc3_tile_desc_global_swz4_outer_itergraph_balstream"
        ),
    )
