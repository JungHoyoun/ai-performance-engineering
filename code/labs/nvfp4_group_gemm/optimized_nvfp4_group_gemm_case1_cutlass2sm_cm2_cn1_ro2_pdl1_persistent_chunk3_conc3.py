"""CUTLASS NVFP4 grouped GEMM (competition case 1) - finer chunked persistent candidate.
...
- raster_order=2
- use_pdl=1
- persistent_request_chunk=3 (five grouped plans for 15 requests)
- persistent_concurrent_streams=1 (harness stream-auditor safe mode)
"""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_cm2_cn1_ro2_pdl1_persistent_chunk3_conc3safe",
    )
