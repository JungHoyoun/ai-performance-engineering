"""CUTLASS NVFP4 grouped GEMM (competition case 1) - persistent graph + global M-zigzag task order."""
...
os.environ["AISP_NVFP4_GROUP_GEMM_PERSISTENT_TASK_ORDER"] = "m_zigzag_global"
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_graph_m_zigzag_global_swz0"
        ),
    )
