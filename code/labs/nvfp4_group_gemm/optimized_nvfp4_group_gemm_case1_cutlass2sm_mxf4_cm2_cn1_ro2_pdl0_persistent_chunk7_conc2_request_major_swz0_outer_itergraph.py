"""CUTLASS NVFP4 grouped GEMM (competition case 1) - 2SM MXF4 chunk7 conc2 outer iter-graph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_chunk7_conc2_request_major_swz0_outer_itergraph"
        ),
    )
