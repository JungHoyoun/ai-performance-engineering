"""CUTLASS NVFP4 grouped GEMM (competition case 0) - tuned 2SM launch.

This wrapper hard-sets the best harness-observed launch knobs for case 0 at
SM=1500/MEM=3996:
- cluster_m=2
- cluster_n=1
- raster_order=1
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_cm2_cn1_ro1_pdl0",
    )
