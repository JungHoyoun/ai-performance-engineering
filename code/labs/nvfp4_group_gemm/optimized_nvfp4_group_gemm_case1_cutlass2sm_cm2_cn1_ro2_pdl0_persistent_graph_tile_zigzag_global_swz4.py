"""CUTLASS NVFP4 grouped GEMM (competition case 1) - persistent graph + tile-zigzag task order + swizzle4."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl0_persistent_graph_tile_zigzag_global_swz4"
        ),
    )
