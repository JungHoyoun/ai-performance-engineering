"""CUTLASS NVFP4 grouped GEMM (competition case 1) - 2SM MXF4 pdl1 chunk8 conc3 swz0 outer iter-graph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn1_ro2_pdl1_persistent_chunk8_conc3_request_major_swz0_outer_itergraph"
        ),
    )
