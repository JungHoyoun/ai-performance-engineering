"""CUTLASS NVFP4 grouped GEMM (competition case 0) - persistent graph + cn2 + tile-zigzag task order + swizzle4."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn2_ro2_pdl1_persistent_graph_tile_zigzag_global_swz4"
        ),
    )
