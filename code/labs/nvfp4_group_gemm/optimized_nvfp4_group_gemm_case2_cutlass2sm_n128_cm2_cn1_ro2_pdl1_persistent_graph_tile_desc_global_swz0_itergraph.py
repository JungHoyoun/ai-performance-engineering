"""CUTLASS NVFP4 grouped GEMM (competition case 2) - best persistent schedule + iter-graph replay."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        prepare=prepare_cutlass_cached_2sm_n128_persistent_graph,
        inputs_per_iteration=15,
        capture_iter_graph=True,
        name=(
            f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_n128_"
            "cm2_cn1_ro2_pdl1_persistent_graph_tile_desc_global_swz0_itergraph"
        ),
    )
