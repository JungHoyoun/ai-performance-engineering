"""CUTLASS NVFP4 grouped GEMM (competition case 1) - n64_s4 chunk8 conc5 cn2 pdl1 tile_desc_global m_desc swz4 outer iter-graph."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=(
            ...
            "cm2_cn2_ro2_pdl1_persistent_chunk8_conc5_tile_desc_global_m_desc_swz4_outer_itergraph"
        ),
    )
