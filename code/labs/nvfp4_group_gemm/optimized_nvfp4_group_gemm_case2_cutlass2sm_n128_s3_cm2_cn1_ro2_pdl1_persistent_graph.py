"""CUTLASS NVFP4 grouped GEMM (competition case 2) - tuned 2SM N128 StageCount=3 fused-request graph replay."""
...
def get_benchmark() -> BaseBenchmark:
    ...
    bench = NVFP4GroupGemmBenchmark(
        ...
        name=f"nvfp4_group_gemm_{case.name}_optimized_cutlass_cached_2sm_n128_s3_cm2_cn1_ro2_pdl1_persistent_graph",
    )
