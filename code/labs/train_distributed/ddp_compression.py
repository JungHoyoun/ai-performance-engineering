...
def main():
    ...
    from torch.distributed.algorithms.ddp_comm_hooks import quantization_hooks, powerSGD
    ...
    if args.compression == "int8":
        ddp_model.register_comm_hook(None, quantization_hooks.quantization_pertensor_hook)
