// baseline_cutlass_gemm_fp16.cu -- CUTLASS FP16 SIMT GEMM baseline.
...
int main() {
    ...
    for (int iter = 0; iter < kIterations; ++iter) {
        NVTX_RANGE("compute_math:cutlass_fp16");
    ...
    std::cout << "CUTLASS FP16 SIMT GEMM (baseline): " << avg_ms << " ms" << std::endl;
