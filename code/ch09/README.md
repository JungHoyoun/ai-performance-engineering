...
| `baseline_structured_sparsity_ffn.py`, `optimized_structured_sparsity_ffn.py` | 2:4 structured sparsity SwiGLU FFN block (GEMM+SwiGLU+GEMM) sized for gpt-oss-20b. |
