"""Baseline dense SwiGLU FFN using 2:4-pruned weights (LLM-style)."""
...
class BaselineStructuredSparsityFFNBenchmark(VerificationPayloadMixin, BaseBenchmark):
    """Dense FFN baseline using pruned 2:4 weights."""
    ...
    def benchmark_fn(self) -> None:
        ...
        with self._nvtx_range("baseline_structured_sparsity_ffn"):
...
def get_benchmark() -> BaseBenchmark:
    return BaselineStructuredSparsityFFNBenchmark()
