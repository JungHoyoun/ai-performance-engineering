"""Optimized batch-heavy GEMM using a 2:4 structured sparse weight matrix."""
...
class OptimizedStructuredSparsityBatchBenchmark(VerificationPayloadMixin, BaseBenchmark):
    """Sparse GEMM optimized with 2:4 structured sparsity (batch-heavy shape)."""
    ...
    def benchmark_fn(self) -> None:
        ...
        with self._nvtx_range("optimized_structured_sparsity_batch"):
...
def get_benchmark() -> BaseBenchmark:
    return OptimizedStructuredSparsityBatchBenchmark()
