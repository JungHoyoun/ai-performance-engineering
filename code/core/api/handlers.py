...
def ai_tools(_: Dict[str, Any]) -> Dict[str, Any]:
    ...
    category_map = {
        ...
        "distributed": ["aisp_distributed_plan", "aisp_distributed_nccl", "aisp_cluster_slurm", "aisp_launch_plan"],
        "inference": ["aisp_inference_vllm", "aisp_inference_quantization"],
        "ai": ["aisp_ask", "aisp_explain", "aisp_ai_status", "aisp_suggest_tools"],
        "profiling": [
            "aisp_profile_flame",
            "aisp_profile_memory",
        ...
        "benchmarks": ["aisp_run_benchmarks", "aisp_benchmark_targets"],
