"""Baseline gradient fusion benchmark (many small all-reduces)."""
...
class BaselineGradientFusionMultiGPU(VerificationPayloadMixin, BaseBenchmark):
...
def get_benchmark() -> BaseBenchmark:
    return BaselineGradientFusionMultiGPU()
