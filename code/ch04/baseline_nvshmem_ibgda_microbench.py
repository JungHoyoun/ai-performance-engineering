"""Baseline NVSHMEM IBGDA microbenchmark (single-GPU)."""
...
class BaselineNvshmemIbgdaMicrobenchSingle(NvshmemIbgdaMicrobench):
    multi_gpu_required = False

    def __init__(self) -> None:
        super().__init__(enable_ibgda=False, world_size=1, **_DEFAULT_KWARGS)
...
def get_benchmark() -> NvshmemIbgdaMicrobench:
    return BaselineNvshmemIbgdaMicrobenchSingle()
