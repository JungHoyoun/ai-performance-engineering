...
Usage:
    1. Auto-export decorator (RECOMMENDED - handles deep hierarchies):
       ```python
       from common.python.benchmark_registry import export_benchmark
    ...
    2. Import check at module level:
       ```python
       from common.python.benchmark_registry import require_get_benchmark
       require_get_benchmark(__name__)  # At end of file
       ```

    3. Manual registration with deep hierarchies:
       ```python
       from common.python.benchmark_registry import register_benchmark
    ...
    4. Validation script (run in CI):
       ```bash
       python -m common.python.benchmark_registry --validate
       ```
"""
