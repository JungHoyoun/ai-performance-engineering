...
from common.python.hardware_capabilities import all_capability_records, refresh_capability_cache


HEADER_PATH = repo_root / "common" / "headers" / "arch_detection.cuh"
