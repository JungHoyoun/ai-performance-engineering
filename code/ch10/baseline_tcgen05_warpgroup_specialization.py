"""Baseline tcgen05 matmul using warp specialization (single consumer warp)."""
...
class BaselineTcgen05WarpgroupSpecializationBenchmark(Tcgen05MatmulBenchmarkBase):
    """Chapter 10 baseline: warp-specialized tcgen05 GEMM (single consumer warp)."""

    matrix_rows = 16384
    matrix_cols = 16384
    shared_dim = 2048
    nvtx_label = "baseline_tcgen05_warpgroup_specialization"
    ...
    def setup(self) -> None:
        ensure_tcgen05_supported(
            ...
            module_name="ch10 tcgen05 warpgroup specialization baseline",
        )
        super().setup()
...
def get_benchmark() -> BaseBenchmark:
    return BaselineTcgen05WarpgroupSpecializationBenchmark()
