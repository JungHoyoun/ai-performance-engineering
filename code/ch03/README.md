...
| `power_perf_watt_tool.py`, `power_tuning_tool.py`, `mig_mps_tool.py`, `green_context_demo.py` | Perf-per-watt estimator, power sweep, MIG/MPS report, and CUDA 13 green-context demo (non-benchmark utilities). |
